...
import { createTopicsPublication } from "@/store/features/categoryPublicationSlice";

const CreateTopicsPulication = ({ openModal }) => {
  ...
  const onSubmit = (e) => {
    ...
    dispatch(createTopicsPublication(data))
      .unwrap()
      .then((response) => {
...
export default CreateTopicsPulication;
