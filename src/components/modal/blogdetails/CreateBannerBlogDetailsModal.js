...
import { createBlogBanner } from "@/store/features/blogDetailsSlice";

const CreateBannerBlogDetailsModal = ({ openModal, blogId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(createBlogBanner({ id: blogId, data: formData }))
      .unwrap()
      .then(() => {
...
export default CreateBannerBlogDetailsModal;
