...
import { createBlogDetails } from "@/store/features/blogDetailsSlice";
import CKEditorClient from "@/utils/editor";
import { toast } from "react-toastify";

const CreateBlogDetailsAdmin = ({ openModal, id }) => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(createBlogDetails({ id, data: formData }))
      .uwrap()
      .then(() => {
        toast.success("Blog Details added successfull");
      })
      .catch((error) => {
        console.log(error);
...
export default CreateBlogDetailsAdmin;
