...
import { updateBanner } from "@/store/features/blogDetailsSlice";
import { toast } from "react-toastify";
import { data } from "autoprefixer";

const UpdateBannerBlogDetailsModal = ({
  openModal,
  blogId,
  existingBanners,
}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(updateBanner({ id: blogId, data: formData }))
      .unwrap()
      .then(() => {
...
export default UpdateBannerBlogDetailsModal;
